...
def game_over() :
    ...
    game_over_surface = my_font.render(
        'Your Score is : ' + str(score), True, Constants.red)
...
while True :
    ...
    fruit_spawn = True
    game_window.fill(Constants.black)

    for pos in snake_body :
        pygame.draw.rect(game_window, Constants.green,
                         pygame.Rect(pos[0], pos[1], 10, 10))
    pygame.draw.rect(game_window, Constants.white, pygame.Rect(
    ...
    show_score(1, Constants.white, 'times new roman', 20)
